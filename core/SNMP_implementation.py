...
def send_msg(my_socket, msg, host, agent_port):
	...
	while True:
		try:
			...
			temp_response = show_response_msg(rxbuf)
			return temp_response
		except socket.timeout:
			print ('Timeout!!')
			return "Timeout while sending message."
		break
...
# MAIN #
def main(hardwareTypePort, goalIp, community, uniqueOid):
	can_ping = False
	...
	agent_port = int(hardwareTypePort)
	print(agent_port)
	...
	response = send_msg(my_socket, s_snmp, agent_IP, agent_port)
